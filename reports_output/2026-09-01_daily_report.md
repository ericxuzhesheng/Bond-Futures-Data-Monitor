...
10年国债收益率为 1.684%，较上一观测日变化 -0.4 bp。FDR007 为 1.390%，变化 -2.0 bp。央行公开市场当日净回笼 3,810 亿元。

模型中的方向性得分来自以下判断。FDR007 下行，银行间资金面边际转松。公开市场净回笼 3810 亿元，资金面压力偏空。
...
| FDR007 | 1.390% | -2.0 bp | +3.0 bp | 95% |
| 期货平均收益 | +0.093% | +0.093% | -0.193% | 85% |
| 总成交量 | 257,685 | +1.7% | 缺失 | 10% |
...
![国债期货累计表现](assets/2026-09-01_futures_20d.svg)
...
| 合约 | 收盘价 | 日收益率 | 成交量 | 持仓量 |
|---|---:|---:|---:|---:|
| TS | 102.586 | 0.0234% | 28,804 | 73,727 |
| TF | 106.475 | 0.0611% | 53,733 | 199,135 |
| T | 109.400 | 0.0732% | 79,021 | 379,217 |
| TL | 116.130 | 0.2157% | 96,127 | 180,676 |
...
![当日与前一观测日国债收益率曲线](assets/2026-09-01_yield_curve.svg)
...
![资金利率历史观测](assets/2026-09-01_funding_20d.svg)
...
![CPI、PPI 与制造业 PMI 历史](assets/2026-09-01_macro_history.svg)
...
| 公开市场操作 | 1.0 | -1.00 | 可用 | 公开市场净回笼 3810 亿元，资金面压力偏空。 |
...
- 历史非零评分记录 143 个，次日方向命中率 58.7%，5日方向命中率 58.6%（n=140）。
...
```text
MOF list returned 12 notices but every article request failed
```

**双源曲线核验 · 正常**

观测日 2026-09-01，共 5 条。
