...
10年国债收益率为 1.713%，较上一观测日变化 -0.2 bp。FDR007 为 1.390%，变化 +0.0 bp。央行公开市场当日净回笼 50 亿元。

宏观基本面是本期唯一产生方向性得分的维度，贡献偏多分值。


模型评分 **+0.50** · 规则置信指标 **100/100**
...
- 历史非零评分记录 189 个，次日方向命中率 59.8%，5日方向命中率 53.0%（n=185）。
