...
10年国债收益率为 1.711%，较上一观测日变化 -0.3 bp。DR007 为 1.388%，变化 +0.6 bp。央行公开市场当日净回笼 18,595 亿元。

模型中的方向性得分来自以下判断。公开市场净回笼 18595 亿元，资金面压力偏空。期货上涨且成交活跃度提高，量价配合偏积极。制造业 PMI 49.2 低于荣枯线，基本面偏弱支撑债市。
...
| DR007 | 1.388% | +0.6 bp | -5.9 bp | 20% |
| 期货平均收益 | +0.092% | +0.092% | +0.129% | 85% |
| 总成交量 | 282,991 | +4.7% | 缺失 | 50% |
...
| 类型 | 期限 | 投放 | 到期 | 净投放 |
|---|---:|---:|---:|---:|
| 买断式逆回购 | 7 天 | 5,000 | 10,000 | -17,255 |
...
| 公开市场操作 | 1.0 | -1.00 | 可用 | 公开市场净回笼 18595 亿元，资金面压力偏空。 |
...
- 历史非零评分记录 127 个，次日方向命中率 59.1%，5日方向命中率 58.5%（n=123）。
