...
国债期货表现分化。TL 表现相对最强，日收益 +0.060%；T 为 +0.000%。

10年国债收益率为 1.680%，较上一观测日变化 -0.0 bp。FDR007 为 1.380%，变化 +1.0 bp。央行公开市场当日净回笼 45 亿元。
...
|---|---:|---:|---:|---:|
| 10Y国债收益率 | 1.680% | -0.0 bp | -0.8 bp | 10% |
| FDR007 | 1.380% | +1.0 bp | -3.0 bp | 50% |
| 期货平均收益 | +0.024% | +0.024% | +0.160% | 65% |
| 总成交量 | 241,851 | -7.8% | -4.5% | 5% |
| 总持仓量 | 861,489 | +1.0% | +3.2% | 100% |

*收益率与资金利率的变化以 bp 计，1 bp 等于 0.01 个百分点。分位只使用已有同口径观测，不足20条时按实际样本计算；无法比较时注明原因。期货5日栏为五次观测的复合收益，成交量和持仓量5日栏为相对五个交易观测前的变化率。*

## 期货表现

![国债期货累计表现](assets/2026-09-07_futures_20d.svg)

*以窗口首个观测日前的100为基准，逐日复合各品种收益率；横轴列出观测日期。*

| 合约 | 日收益 | 持仓变化 | 成交量/均值 | 持仓量/均值 | 量价状态 |
|---|---:|---:|---:|---:|---|
| TS | +0.008% | -1.23% | 0.76x | 1.05x | 价涨减仓 |
| TF | +0.028% | +0.20% | 0.69x | 1.13x | 价涨增仓 |
| T | +0.000% | +0.68% | 0.73x | 1.20x | 价涨增仓 |
| TL | +0.060% | +3.48% | 0.77x | 1.15x | 价涨增仓 |
...
| 合约 | 收盘价 | 日收益率 | 成交量 | 持仓量 |
|---|---:|---:|---:|---:|
| TS | 102.578 | 0.0078% | 30,144 | 71,894 |
| TF | 106.465 | 0.0282% | 53,159 | 204,669 |
| T | 109.430 | 0.0000% | 79,003 | 390,116 |
| TL | 116.440 | 0.0602% | 79,545 | 194,810 |
...
![当日与前一观测日国债收益率曲线](assets/2026-09-07_yield_curve.svg)

| 结构 | 当前 | 1日变化 | 5日变化 |
|---|---:|---:|---:|
| 2s10s | +44.2 bp | +0.5 bp | +0.7 bp |
| 10s30s | +45.2 bp | -0.2 bp | -0.9 bp |
| 2s5s10s蝶式 | +11.9 bp | -1.2 bp | -0.2 bp |
...
|---|---:|---:|---:|---|
| 1Y | 1.2307% | 1.2307% | +0.00 bp | 2026-09-07 |
| 3Y | 1.2453% | 1.2453% | +0.00 bp | 2026-09-07 |
| 5Y | 1.4022% | 1.3994% | -0.28 bp | 2026-09-07 |
| 10Y | 1.6798% | 1.6799% | +0.01 bp | 2026-09-07 |
| 30Y | 2.1325% | 2.1320% | -0.05 bp | 2026-09-07 |
...
![资金利率历史观测](assets/2026-09-07_funding_20d.svg)
...
| FDR007 | 1.380% | +1.0 bp |
| FR007 | 1.410% | +0.0 bp |
| SHIBOR_7D | 1.380% | +0.4 bp |
| SHIBOR_ON | 1.372% | +1.0 bp |
...
![CPI、PPI 与制造业 PMI 历史](assets/2026-09-07_macro_history.svg)
...
- 历史非零评分记录 206 个，次日方向命中率 59.2%，5日方向命中率 52.0%（n=202）。
...
| 数据类别 | 来源 |
|---|---|
| 国债期货 | `akshare_cffex_daily:20260907` |
| 收益率曲线 | `akshare_bond_china_close_return:2026-09-07` |
| 资金利率 | `akshare_chinamoney_repo_rate:2026-09-07, akshare_jin10_shibor:2026-09-07` |
| 公开市场操作 | `pbc_official:https://www.pbc.gov.cn/zhengcehuobisi/125207/125213/125431/125475/2026090709060799588/index.html` |
| 政策/新闻 | `akshare_cls_telegraph:2026-09-07` |
...
- 公开市场业务交易公告 \[2026\]第174号

### 数据状态

**国债收益率 · 正常**

观测日 2026-09-07，共 5 条。
...
```text
MOF list returned 8 notices but every article request failed
```
