...
国债期货表现分化。TL 表现相对最强，日收益 +0.052%；TF 为 -0.052%。

10年国债收益率为 1.717%，较上一观测日变化 +0.5 bp。DR007 为 1.420%，变化 -2.6 bp。央行公开市场当日净投放 2,745 亿元。

模型中的方向性得分来自以下判断。DR007 下行，银行间资金面边际转松。公开市场净投放 2745 亿元，资金面支持偏多。制造业 PMI 49.2 低于荣枯线，基本面偏弱支撑债市。


模型评分 **+2.50** · 规则置信指标 **100/100**
...
|---|---:|---:|---:|---:|
| 10Y国债收益率 | 1.717% | +0.5 bp | -1.7 bp | 10% |
| DR007 | 1.420% | -2.6 bp | -1.3 bp | 55% |
| 期货平均收益 | -0.016% | -0.016% | +0.241% | 35% |
| 总成交量 | 289,977 | -5.3% | 缺失 | 60% |
| 总持仓量 | 865,136 | -3.1% | -1.4% | 25% |

*收益率与资金利率的变化以 bp 计，1 bp 等于 0.01 个百分点。分位只使用已有同口径观测，不足20条时按实际样本计算；缺失比较标为“缺失”。期货5日栏为五次观测的复合收益。*

## 期货表现

![国债期货累计表现](assets/2026-08-03_futures_20d.svg)

*以窗口首个观测日前的100为基准，逐日复合各品种收益率；横轴列出观测日期。*

| 合约 | 日收益 | 持仓变化 | 成交量/均值 | 持仓量/均值 | 量价状态 |
|---|---:|---:|---:|---:|---|
| TS | -0.027% | -4.04% | 1.18x | 0.94x | 价跌减仓 |
| TF | -0.052% | -3.27% | 1.09x | 0.95x | 价跌减仓 |
| T | -0.037% | -3.37% | 1.20x | 0.97x | 价跌减仓 |
| TL | +0.052% | -1.96% | 0.81x | 1.07x | 价涨减仓 |
...
| 合约 | 收盘价 | 日收益率 | 成交量 | 持仓量 |
|---|---:|---:|---:|---:|
| TS | 102.604 | -0.0273% | 46,385 | 84,714 |
| TF | 106.470 | -0.0516% | 70,647 | 214,437 |
| T | 109.345 | -0.0366% | 101,182 | 364,084 |
| TL | 115.420 | 0.0520% | 71,763 | 201,901 |
...
![当日与前一观测日国债收益率曲线](assets/2026-08-03_yield_curve.svg)

| 结构 | 当前 | 1日变化 | 5日变化 |
|---|---:|---:|---:|
| 2s10s | +45.3 bp | +0.0 bp | -1.3 bp |
| 10s30s | +47.2 bp | -0.2 bp | +1.3 bp |
| 2s5s10s蝶式 | +15.0 bp | -0.1 bp | +3.8 bp |
...
![资金利率历史观测](assets/2026-08-03_funding_20d.svg)
...
| DR007 | 1.420% | -2.6 bp |
| R007 | 1.612% | -2.9 bp |
| SHIBOR_7D | 1.431% | -2.2 bp |
| SHIBOR_ON | 1.413% | +0.3 bp |
...
![CPI、PPI 与制造业 PMI 历史](assets/2026-08-03_macro_history.svg)
...
香港证监会主席黄天祐：港交所国债期货是离岸产品的重大突破，资金面信息需结合价格变化判断

资金流动性 · 中性 · 全曲线 · 相关合约 TS, TF, T, TL · 文本置信指标 3/5

香港证监会主席黄天祐：港交所国债期货是离岸产品的重大突破影响持仓成本和短端预期，方向取决于净投放规模与资金利率表现。

**央行连续四日隔夜逆回购累计投放2.1万亿，重大会议定调降准降息窗口打开，南方基金关注货币政策窗口下的资产配置节奏**

央行连续四日隔夜逆回购累计投放2.1万亿，重大会议定调降准降息窗口打开，南方基金关注货币政策窗口，货币或流动性信号偏宽

货币政策 · 偏多 · 全曲线 · 相关合约 TS, TF, T, TL · 文本置信指标 4/5

央行连续四日隔夜逆回购累计投放2.1万亿，重大会议定调降准降息窗口打开，南方基金关注货币政策窗口指向流动性边际改善，压低资金和利率预期，对国债期货偏多。

**政策底+机构底双重确认，红利资产"减震器"功能凸显**

政策底+机构底双重确认，红利资产"减震器"功能凸显，货币或流动性信号偏紧

货币政策 · 偏空 · 全曲线 · 相关合约 TS, TF, T, TL · 文本置信指标 4/5

政策底+机构底双重确认，红利资产"减震器"功能凸显可能推高资金利率或收紧预期，国债期货面临压力。

**财联社8月3日早间新闻精选**

财联社8月3日早间新闻精选，货币或流动性信号偏紧

货币政策 · 偏空 · 全曲线 · 相关合约 TS, TF, T, TL · 文本置信指标 4/5

财联社8月3日早间新闻精选可能推高资金利率或收紧预期，国债期货面临压力。
...
| 公开市场操作 | 1.0 | +1.00 | 可用 | 公开市场净投放 2745 亿元，资金面支持偏多。 |
...
- 历史非零评分记录 123 个，次日方向命中率 60.2%，5日方向命中率 59.7%（n=119）。
